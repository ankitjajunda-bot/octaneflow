...
function renderApprovalsPanel() {
  ...
  const masterSelectState = new Map();
  ...
  const reviewed = (db.pending_entries || []).filter(e => !['pending', 'queued', 'syncing', 'pending_approval'].includes(e.status) && e.entryData && e.entryData.date)
